                    ...
                    <tr>
                        <td style="text-align:center;">
                          <a href="dashboard.crypfx.com" title="crypfx-logo" target="_blank">
                            <img width="160" src="https://dashboard.crypfx.uk/_next/image?url=%2Fimages%2Flogos%2Flogo.png&w=256&q=75" title="logo" alt="logo">
                          </a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            ...
                                            following link and follow the instructions.<br/><br/>

                                            You can copy the link and paste it if the button doesn't work. <br/>

                                            https://dashboard.crypfx.uk/auth/forgot-password/reset?token=${token}
                                            
                                        </p>
                                        <a href="https://dashboard.crypfx.uk/auth/forgot-password/reset?token=${token}"
